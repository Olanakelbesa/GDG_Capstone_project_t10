    ...
    <>
      <div className="mx-0 flex">
        <div className="rounded w-full shadow-lg mx-14 my-14 mr-0">
          ...
          <div
            className="flex items-center rounded hover:bg-gray-300 transform hover:scale-110 transition duration-150 cursor-pointer"
          >
            <FaArrowRight className="m-5" />
          ...
          <hr className="opacity-15" />
          <div className="flex items-center rounded hover:bg-gray-300 transform hover:scale-110 transition duration-150" onClick={scrollToStory}>
            <FaArrowRight className="m-5" />
            <p>Stories</p>
          </div>
          <hr className="opacity-15" />
